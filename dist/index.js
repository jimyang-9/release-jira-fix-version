...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.VERSION_ID = exports.SUBDOMAIN = exports.API_TOKEN = exports.EMAIL = void 0;
...
exports.VERSION_ID = core.getInput('version-id', { required: true });
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const version = yield client_1.getJiraVersion(env_1.EMAIL, env_1.API_TOKEN, env_1.SUBDOMAIN, env_1.VERSION_ID);
            if (!version) {
                core.setFailed('Could not find version');
            }
            if ((version === null || version === void 0 ? void 0 : version.released) === true) {
